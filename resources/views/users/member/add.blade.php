            ...
            <div class="row">
                <div class="col-sm-4 imgUp text-center">
                    ...
                    <label class="btn btn-primary">Upload
                        <input type="file" class="uploadFile img" name="image_front[]" value="Upload Photo"
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-4 imgUp text-center">
                    <div class="imagePreview"></div>
                    <label class="btn btn-primary">Upload
                        <input type="file" class="uploadFile img" name="image_left[]" value="Upload Photo"
                            style="width: 0px;height: 0px;overflow: hidden;">
                    </label>
                </div>
                <div class="col-sm-4 imgUp text-center">
        ...
        <div class="form-group">
            ...
            <div class="row">
                <div class="col-sm-4 imgUp text-center">
                    <div class="imagePreview"></div>
                    <label class="btn btn-primary">Upload
                        <input type="file" class="uploadFile img" name="image_right[]" value="Upload Photo"
                            style="width: 0px;height: 0px;overflow: hidden;">
                    </label>
                </div>
                <div class="col-sm-4 imgUp text-center">
